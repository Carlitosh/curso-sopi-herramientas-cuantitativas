...
en la carpeta \file{raster\_data,LC82240782016304}. Esta imagen  corresponde al
...
\file{LC82240782016304LGN00.vrt}. Una vez abierta, podremos encontrarla
...
\file{vector\_data/} con el nombre \file{firmas.shp} como se ve en la figura
\ref{fig:newshape}.
...
Al terminar de hacerlo QGIS pedir\'a un n\'umero de ID para la capa que debe ser
...
ubicado en la carpeta \file{aux\_data}}. Adem\'as podemos acceder a la tabla de
