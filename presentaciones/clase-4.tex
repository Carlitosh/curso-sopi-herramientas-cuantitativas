...
\begin{frame}{Transformada tasseled-cap}
  ...
  \end{block}\pause
  \begin{block}{Idea}
    Encontrar alguna transformación que me permita descartar bandas pero que tengan relación con distintos comportamientos biof\'isicos.
  \end{block}
\end{frame}
%--- Next Frame ---%
...
\begin{frame}{Transformada tasseled-cap}
  ...
  \caption{Movimiento asociado al comportamiento fenológico de un p\'ixel de vegetación en el espacio vectorial.\footfullcite{richards2013remote}}
  \end{figure}
\end{frame}
%--- Next Frame ---%
...
\begin{frame}{Práctica}
  \begin{exampleblock}{Actividades prácticas de la tercer clase}
    \begin{enumerate}
      ...
      \item Realizar curvas fenológicas a partir del \'indice de vegetación en la imagen MODIS.
