...
\begin{frame}{Medición}
  \begin{block}{Definición:}
    La distribución de la reflectancia es función de la longitud de onda nos habla de la caracter\'isticas intr\'insecas de la cobertura. Es su firma espectral $\rho_\lambda$.
  \end{block}
\end{frame}
%--- Next Frame ---%
