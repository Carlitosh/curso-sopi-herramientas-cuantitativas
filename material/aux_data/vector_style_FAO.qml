...
<qgis version="2.14.1-Essen" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="MC_ID">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
  ...
  <renderer-v2 attr="MC_ID" forceraster="0" symbollevels="0" type="categorizedSymbol" enableorderby="0">
    <categories>
      <category render="true" symbol="0" value="1" label="Áreas terrestres cultivadas y manejada"/>
      <category render="true" symbol="1" value="2" label="Vegetación natural y semi-natural"/>
      <category render="true" symbol="2" value="3" label="Áreas acuáticas o regularmente inundadas cultivadas"/>
      <category render="true" symbol="3" value="4" label="Vegetación natural y semi-natural acuática o regularmente inundadas"/>
      <category render="true" symbol="4" value="5" label="Superficies artificiales y áreas asociadas"/>
      <category render="true" symbol="5" value="6" label="Áreas descubiertas o desnudas"/>
      <category render="true" symbol="6" value="7" label="Cuerpos artificiales de agua, nieve y hielo"/>
      <category render="true" symbol="7" value="8" label="Cuerpos naturales de agua, nieve y hielo"/>
      <category render="true" symbol="8" value="" label="Sin clase"/>
    </categories>
    <symbols>
